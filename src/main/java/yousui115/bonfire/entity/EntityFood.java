...
public class EntityFood extends EntityBroilItem
{
    ...
    //■食材の状態変異Map
    public static Map<Pair<IRegistryDelegate<Item>, Integer>, List<ItemStack>> mapFoodState = com.google.common.collect.Maps.newHashMap();
    ...
    public void onUpdate()
    {
        ...
        if (this.getBroilTime() < BROIL_TIME_BURNT && bonfire.state.isBurning == true)
        {
            //■調理時間の加算
